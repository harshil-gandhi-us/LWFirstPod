    ...
    @objc public class LWDeviceInfo: NSObject {
        ...
        @objc public func showDeviceInfoAlert(from viewController: UIViewController? = nil) {
            ...
            let alert = UIAlertController(
                title: "Device Details", message: message, preferredStyle: .alert)
        ...
        public var appMemoryUsage: String {
            ...
            if kerr == KERN_SUCCESS {
                return ByteCountFormatter.string(
                    fromByteCount: Int64(taskInfo.resident_size), countStyle: .memory)
            } else {
                return "0"
            }
        }
        ...
        public var deviceUsedStorage: String {
            ...
            {
                return ByteCountFormatter.string(
                    fromByteCount: totalSize - freeSize, countStyle: .file)
            }
            return "0"
        }
        ...
        public var firstInstallTime: String {
            if let urlToDocumentsFolder = FileManager.default.urls(
